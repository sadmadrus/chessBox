...
- `timewhite`, `timeblack` — время на часах игроков белыми/чёрными на момент начала игры, соответственно (в секундах); по умолчанию — полное время перед первым ходом для заданного формата времени.
